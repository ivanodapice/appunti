...
\newcommand\correct[2]{\ensuremath{\:}{\color{red}{#1}}\ensuremath{\to
}{\color{correct}{#2}}\ensuremath{\:}}
...
\declaretheorem[style=conjpurplebox, name=Congettura,
numberwithin=section]{congettura}
...
\item[\hskip\labelsep
  ...
  \begin{mdframed}[linewidth=2pt,rightline=false, topline=false,
    bottomline=false,linecolor=RawSienna, backgroundcolor=RawSienna!1]
  }{%
...
\declaretheorem[style=thmexplanationbox, numbered=no,
name=Dimostrazione]{dimostrazione}
\declaretheorem[style=thmexplanationbox, numbered=no,
name=Spiegazione]{spiegazione}
\newenvironment{spiegaz}[1][]{\vspace{-10pt}\pushQED{\(\circledast\)}
\begin{spiegazione}}{\null\hfill\popQED
\end{spiegazione}}
...
\newenvironment{risposta}[1][]{\vspace{-10pt}\pushQED{\(\circledast\)}
\begin{tmprisposta}}{\null\hfill\popQED
\end{tmprisposta}}
...
\newenvironment{attenzione}{\par\small % smaller font size
  ...
  \item\ignorespaces % Indentation on the right
    \makebox[-2.5pt]{
      \begin{tikzpicture}[overlay, baseline=(current bounding box)]
        \node[draw=cPrim!85,line
          width=1pt,circle,fill=cPrim!25,font=\sffamily\bfseries,inner
        sep=2pt,outer sep=0pt] at
        (-15pt,4pt){\textcolor{cPrim}{\hspace{-2pt}\textbf{!}}};
    \end{tikzpicture}} % Orange R in a circle
  \advance\baselineskip -1pt}{
\end{list}} % Tighter line spacing
...
{\llap{\colorbox{White!0!cPrim}{\parbox{1.25cm}{\hfill\color{white}\thesection}}}}%
% label
...
{\llap{\colorbox{White!37!cPrim}{\parbox{1.25cm}{\hfill\color{white}\thesubsection}}}}%
% label
{1em}% horizontal separation between label and title body
{}% before the title body
[]% after the title body
...
% begin appendix autoref patch [\autoref subsections in
% appendix](https://tex.stackexchange.com/questions/149807/autoref-subsections-in-appendix)
\makeatletter
...
\apptocmd{\subappendices}{\toggletrue{inappendix}}{}{\errmessage{failed
to patch}}
