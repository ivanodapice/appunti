...
\begin{proposizione}
  Sia $V$ uno spazio vettoriale qualunque, l'opposto di
  $\underline{v}\cdot0$ è $(-1)\underline{v}$\\
  \begin{dimostrazione}
    \phantom{}\\
    $\underline{v}+(-1)\underline{v}=0$\\
    $\underline{v}+(-1)\underline{v}=1\cdot
    \underline{v}+(-1)\underline{v}=(1-1)\underline{v}=0\cdot
    \underline{v}=0$, per la proposizione III.2
  \end{dimostrazione}
\end{proposizione}
\newpage
\begin{proposizione}
  Sia $V$ uno spazio vettoriale qualunque, $k\cdot
  \underline{v}=\underline{0}$, se $k=0$ o $\underline{v}=\underline{0}$\\
  \begin{dimostrazione}
    \phantom{}\\
    Se $k=0$ è vera per la proposizione III.2\\
    Se $k\neq0, \exists \frac{1}{k}\in\mathbb{R}: k\cdot
    \underline{v}=\underline{0}$\\
    $\frac{1}{k}(k\cdot \underline{v})=\frac{1}{k}\cdot \underline{0}$\\
    $\frac{1}{k}(k\cdot \underline{v})=\underline{0}$ Per la
    proposizione III.1\\
...
\begin{proposizione}
  In uno spazio vettoriale $V\in\mathbb{R}$ se $\exists
  \underline{v}\neq 0$ allora $V$ contiene infiniti vettori\\
  \begin{dimostrazione}
    \phantom{}\\
    $1\underline{v}, 2\underline{v}, 3\underline{v},...,
    n\underline{v}$ facciamo vedere che sono a due a due distinte\\
...
\begin{proposizione}
  ...
  Come vediamo, se un insieme di vettori ha cardinalità minore della
  ...
  Un \textbf{Sistema di vettori} è un insieme in cui contano l'ordine
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[height=0.24\textwidth]{Figures/insiemi sistemi
    vettoriali.pdf}
  ...
  Data una base, per trovarne una nuova, basta cambiare l'ordine dei
  ...
  \begin{proposizione}
    ...
    \begin{es}
      $B=[
        ...
        \begin{pmatrix}
          ...
          0 & 55
      \end{pmatrix}]$\\
      Calcolare le componenti del vettore $
      \begin{pmatrix}
        1 & 2\\
        3 & 4
    ...
    \end{es}
    \begin{es}
      Data la base $B^{'}=[(1,2),(3,4)]$ di $\mathbb{R}^2$ calcolare
      il vettore di componenti $(5,8)$\\
  ...
  \begin{definizione}
    ...
    \end{tabular}
    \begin{tikzpicture}[remember picture,overlay,> = stealth',shorten
      <= 4pt,shorten > = 4pt]
  ...
  \begin{teorema}[Dipendenza lineare e matrici]
    \phantom{}\\
    $V=\mathbb{R}^n$ se $[\underline{v}_1,\cdots,\underline{v}_n]$ è
    linearmente indipendente e quindi se e solo se $\det
    \begin{pmatrix}
      \underline{v}_1\\
      \cdots\\
      \underline{v}_n
    ...
    \begin{dimostrazione}[da dx a sx, n=4]
      \phantom{}\\
      Se
      $[\underline{v}_1,\underline{v}_2,\underline{v}_3,\underline{v}_4]$
      è linearmente dipendente, allora, almeno uno di essi è
      combinazione lineare degli altri [teorema di
      caratterizzazione], quindi supponiamo che
      $\underline{v}_4=\alpha\underline{v}_1+\beta\underline{v}_2+\gamma\underline{v}_3$\\
      $\det
      \begin{pmatrix}
        \underline{v}_1\\
        \underline{v}_2\\
  ...
  \begin{corollario}[relativo alla terza proprietà]
    ...
    \begin{es}
      ...
      \begin{pmatrix}
        ...
        1, 1, 1, 1
      \end{pmatrix}$\\
      Abbiamo trasformato $\underline{a}_2$ in
      $\underline{a}_2-2\underline{a}_1$  per far diventare $\underline{a}_4=0$
    \end{es}
  \end{corollario}
