...
\begin{esercizio}
	...
	\begin{center}
		\begin{tikzpicture}
			...
			% Vettore u
			\draw[->, thick, blue] (0,0) -- (2,3) node[midway, above, sloped] {$\vec{u}$};
			\filldraw[blue] (2,3) circle (2pt) node[right] {$(2, 3)$};
			
			% Vettore v
			\draw[->, thick, red] (2,3) -- (6,4) node[midway, above, sloped] {$\vec{v}$};
			\filldraw[red] (6,4) circle (2pt) node[right] {$(6, 4)$};
			
			% Vettore risultante u + v
			\draw[->, thick, purple] (0,0) -- (6,4) node[midway, above, sloped] {$\vec{u} + \vec{v}$};
...
\begin{esercizio}
	...
	\begin{center}
		\begin{tikzpicture}
			...
			% Vettore u
			\draw[->, thick, blue] (0,0) -- (5,2) node[midway, above, sloped] {$\vec{u}$};
			\filldraw[blue] (5,2) circle (2pt) node[right] {$(5, 2)$};
			
			% Vettore -v
			\draw[->, thick, red] (5,2) -- (3,-1) node[midway, above, sloped] {$-\vec{v}$};
			\filldraw[red] (3,-1) circle (2pt) node[right] {$(3, -1)$};
			
			% Vettore risultante u - v
			\draw[->, thick, purple] (0,0) -- (3,-1) node[midway, below, sloped] {$\vec{u} - \vec{v}$};
...
\begin{esercizio}
	...
	\begin{center}
		\begin{tikzpicture}
			...
			% Vettore u
			\draw[->, thick, blue] (0,0) -- (1,4) node[midway, right, sloped] {$\vec{u}$};
			\filldraw[blue] (1,4) circle (2pt) node[right] {$(1, 4)$};
			
			% Vettore risultante 1/2 u
			\draw[->, thick, purple] (0,0) -- (0.5,2) node[midway, right, sloped] {$\frac{1}{2}\vec{u}$};
