...
\begin{document}
    ...
    \begin{figure}[H]
    	...
    	\begin{tikzpicture}
    		...
    		\load{1}{b}[-90][1][1];
       		\notation{1}{d}{$4,07kNm$}[left=.5cm];
    		\notation{1}{e}{$1,02kNm$}[right=.5cm];
    		\notation{1}{c}{$47,29kN$}[above right=3mm];
    		\notation{1}{ccccc}{$R_a$}[below right=4mm];
    		\notation{1}{bbbbb}{$R_{bsx}$}[below left=4mm];
    	\end{tikzpicture}
    	\caption{Tratto BC.}
    ...
    \leavevmode\newline
    \leavevmode\newline
    $R_{bsx}\phantom{,}4,90m=115,85kNm-1,02kNm$
    \leavevmode\newline
    \leavevmode\newline
    ...
    \begin{figure}[H]
    	...
    	\begin{tikzpicture}
    		...
    		\load{1}{a}[-90][1][1];
    		\load{1}{b}[-90][1][1];
    		\notation{1}{d}{$1,02kNm$}[left=.5cm];
    		\notation{1}{c}{$47,29kN$}[above right=3mm];
    		\notation{1}{ccccc}{$R_{bdx}$}[below right=4mm];
    		\notation{1}{bbbbb}{$R_c$}[below left=4mm];
    	\end{tikzpicture}
    	\caption{Tratto CD.}
    ...
    \begin{alignat*}{5}
    	\Sigma Y\phantom{_b}   & {}=0{} & \phantom{123456} & R_{bdx}+R_c-qL        & {}=0{}\\
    	\Sigma M_c & {}=0{} & \phantom{123456} & \frac{qL^{2}}{2}-R_cL& {}=0{} 
    \end{alignat*}
    \leavevmode\newline
    \leavevmode\newline
    $R_c\phantom{,}4,90m=115,86kNm$
    \leavevmode\newline
    \leavevmode\newline
    $R_c=\frac{115,85kNm}{4,90m}=23,64kN$
    \leavevmode\newline
    \leavevmode\newline
    $R_{bdx}=47,29kN-23,64kN=23,65kN$
    \leavevmode\newline
    \leavevmode\newline
    \leavevmode\newline
    \leavevmode\newline
    \leavevmode\newline
    $\textbf{R}_a=23,99kN,\leavevmode\newline \textbf{R}_b=47,64kN,\leavevmode\newline \textbf{R}_c=23,64kN,\leavevmode\newline \textbf{M}_{c}^{dx}=\textbf{M}_{c}^{sx}(\varphi_{c})=1,02kNm$
