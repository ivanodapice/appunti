...
\begin{document}
    ...
    \leavevmode\newline
    \leavevmode\newline
    $\gamma$) \textbf{EQUAZIONE DI EQUILIBRIO AL NODO.} 
    \leavevmode\newline
    \leavevmode\newline
    \begin{tightcenter}
   ...
   \leavevmode\newline
    ...
    \begin{figure}[H]
    \hspace*{-.8cm}\includegraphics[width=1.4\linewidth, angle=270]{"immagini/caso 2.png"}
    \end{figure}
    
    \section{Combinazione di carico n° 3}

    \begin{figure}[H]
    	\hspace*{-.5cm}\includegraphics[width=1.4\linewidth, angle=270]{"immagini/caso 3.png"}
    \end{figure}

    \section{Inviluppo momenti}

    \begin{figure}[H]
    	\hspace*{+1.3cm}\includegraphics[width=1.4\linewidth, angle=270]{"immagini/inviluppo momenti.png"}
    \end{figure}
