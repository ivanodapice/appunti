...
\begin{document}
   ...
   \leavevmode\newline
    ...
    \begin{alignat*}{5}
    	\Sigma Y\phantom{_b}   & {}=0{} & \phantom{123456} & R_b+R_{csx}-55,86kN       & {}=0{}\\
    	\Sigma M_b & {}=0{} & \phantom{123456} & \frac{55,86kN\cdot4,90m}{2}-R_{csx}\cdot4,90m+33,19kNm-4,07kNm & {}=0{} 
    \end{alignat*}
    \leavevmode\newline
    \leavevmode\newline
    $R_{csx}\cdot\phantom{,}4,90m=136,86kNm+29,12kNm$
    \leavevmode\newline
    \leavevmode\newline
    $R_{csx}=\frac{165,98kNm}{4,90m}=33,87kN$
    \leavevmode\newline
    \leavevmode\newline
    ...
    \begin{alignat*}{5}
    	\Sigma Y\phantom{_b}   & {}=0{} & \phantom{123456} & R_{cdx}+R_c-55,86kN & {}=0{}\\
    ...
    \leavevmode\newline
    \leavevmode\newline
    $R_{cdx}=55,86kN-21,16kN=34,70kN$
    \leavevmode\newline
    \leavevmode\newline
    \leavevmode\newline
    \leavevmode\newline
    \leavevmode\newline
    $\textbf{R}_b=21,99kN,\leavevmode\newline \textbf{R}_{csx}=33,87kN,\leavevmode\newline \textbf{R}_{cdx}=34,70kN,\leavevmode\newline \textbf{R}_d=21,16kN\leavevmode\newline$
    ...
    \begin{equation}
    	\begin{cases}
    		T(x)&=R_{cdx}-q\cdot x \\ \\
    		M(x)&=R_{cdx}\cdot x-M_c-\frac{q\cdot x^2}{2}\\ \\ 
    	\end{cases}
    	\hfill
    \end{equation}
    \leavevmode\newline
    ...
    \begin{figure}[H]
    	...
    	\begin{tikzpicture}
    		...
    		\support{1}{c}[0];                               
    		\support{1}{d}[0];
    		\internalforces{a}{b}{0}{0.678}[0][red][0];
    ...
    \begin{figure}[H]
    	\hspace*{-3.7cm}\includegraphics[width=1.5\linewidth]{"immagini/inviluppo momenti.png"}
    \end{figure}
